...
<body>
                                        ...
                                        <div class="col-xl-4 col-md-8 mx-auto">
                                            <div class="product-img-slider sticky-side-div">
                                                ...
                                                <div class="swiper product-nav-slider mt-2">
                                                    <div class="swiper-wrapper list-under">
                                                        <div class="swiper-slide">
                                                        ...
                                                        <div class="p-2 border border-dashed rounded">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <h5 class="mb-0 revenue">$60,645</h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="mt-4">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2 size">
                                                                ...
                                                                <div data-bs-toggle="tooltip"
                                                                    data-bs-trigger="hover" data-bs-placement="top"
                                                                    title="04 Items Available" data-id="m">
                                                                    <input type="radio" class="btn-check"
                                                                        name="productsize-radio"
                                                                ...
                                                                <div data-bs-toggle="tooltip"
                                                                    data-bs-trigger="hover" data-bs-placement="top"
                                                                    title="06 Items Available" data-id="l">
                                                                    <input type="radio" class="btn-check"
                                                                        name="productsize-radio"
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class=" mt-4">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2 color">
                                                                <div data-bs-toggle="tooltip"
                                                                    data-bs-trigger="hover" data-bs-placement="top"
                                                                ...
                                                                <div data-bs-toggle="tooltip"
                                                                    data-bs-trigger="hover" data-bs-placement="top"
                                                                    title="02 Items Available" data-id="light">
                                                                    <button type="button"
                                                                ...
                                                                <div data-bs-toggle="tooltip"
                                                                    data-bs-trigger="hover" data-bs-placement="top"
                                                                    title="04 Items Available" data-id="pink">
                                                                    <button type="button"
                                                                ...
                                                                <div data-bs-toggle="tooltip"
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-20 text-pink">
                                                                        <i class="ri-checkbox-blank-circle-fill"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
    ...
    <script>
        ...
        var size = $('.size > div').first().data('id');
        var color = $('.color > div').first().data('id');
        var data = {
            size: size,
            color: color,
